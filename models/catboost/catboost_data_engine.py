...
class RealDataEngineCatboost():
    ...
    - Источник данных между real и моделями Catboost
        ...
        - Pool для catboost создается вызовом отдельного метода,
        catboost.Pool - это родной формат для catboost, данные в этом формате подаются на вход модели
    ...
    def train_pool(self, force=False):
        ...
        при необходимости можно сохранить в файл
